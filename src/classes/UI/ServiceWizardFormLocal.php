 ...
 */
class ServiceWizardFormLocal extends \Ease\TWB\Form {
    ...
    function __construct($service) {
        parent::__construct('active-service');
    ...
    function finalize() {
        ...
        $addNewItem = new \Ease\Html\InputSearchTag('check_command',
                $this->service->getDataValue('check_command'),
        ...
        $this->addItem(new \Ease\TWB\FormGroup(_('Parameters'),
                        ...
                        _('Additional command params. (For nrpe divided by "!")')));
