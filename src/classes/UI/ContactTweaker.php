...
class ContactTweaker extends \Ease\Html\DivTag {
        ...
        if ($oPage->isPosted()) {
            ...
            if (isset($contactType) && strlen($contactData)) {
                if ($this->contact->fork([$contactType => $contactData])) {
                    ...
                    $this->cnt = \Ease\WebPage::singleton()->getRequestValue('cnt');
                }
            }
    ...
    public function finalize() {
        ...
        if (count($this->subcontactTypes)) {
            ...
            $form = new \Ease\TWB\Form(['name' => 'ContatctTweak', 'action' => 'contacttweak.php']);
            ...
            $form->addItem(
                    new \Ease\TWB\FormGroup(_('Contact'),
                            new \Ease\Html\InputTextTag('cnt', $this->cnt,
                                    ['maxlength' => 80]),
                            \Ease\WebPage::singleton()->getRequestValue('cnt'),
