...
$resetForm->addItem(new \Ease\TWB\SubmitButton(_('Vymazat všechna data'), 'danger'));
...
$resyncForm->addItem(new \Ease\TWB\SubmitButton(_('Provést operaci'), 'warning', array('onClick' => "$('#preload').css('visibility', 'visible');")));
$toolRow->addColumn(6, new \Ease\TWB\Well($resyncForm));

$oPage->container->addItem(new \Ease\TWB\Panel(_('Pročištění databáze'), 'danger', $toolRow));
