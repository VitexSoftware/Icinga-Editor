...
switch ($oPage->getRequestValue('action')) {
    ...
    case 'delete':
        ...
        $confirmator->addItem(new \Ease\TWB\LinkButton('?' . $host->keyColumn . '=' . $host->getID(), _('No') . ' ' . \Ease\TWB\Part::glyphIcon('ok'), 'success'));
        $confirmator->addItem(new \Ease\TWB\LinkButton('?delete=true&' . $host->keyColumn . '=' . $host->getID(), _('Yes') . ' ' . \Ease\TWB\Part::glyphIcon('remove'), 'danger'));
