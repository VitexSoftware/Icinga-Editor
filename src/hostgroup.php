...
$form = new \Ease\TWB\Form(['name'=>'Hostgroup', 'action'=>'hostgroup.php','class' => 'form-horizontal'], $hostgroupEdit);
$form->setTagID($form->getTagName());
if (!is_null($hostgroup->getMyKey())) {
    $form->addItem(new \Ease\Html\InputHiddenTag($hostgroup->getKeyColumn(),
            $hostgroup->getMyKey()));
}
