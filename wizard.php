...
$oPage->columnII->addItem(new EaseTWBLinkButton('wizard-active.php', _('Aktivní'), 'success', array('class' => 'btn-xlarge')));
$oPage->columnII->addItem(new EaseTWBLinkButton('wizard-passive.php', _('Pasivní'), 'info', array('class' => 'btn-xlarge')));
